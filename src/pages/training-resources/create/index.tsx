...
import { createTrainingResource } from 'apiSdk/training-resources';
...
function TrainingResourceCreatePage() {
  ...
  const handleSubmit = async (values: TrainingResourceInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createTrainingResource(values);
      resetForm();
    } catch (error) {
      setError(error);
    }
