...
function TrainingGroupListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<TrainingGroupInterface[]>(
    ...
    () =>
      getTrainingGroups({
        relations: ['academy', 'player_group.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('training_group', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && <Th>Edit</Th>}
                  {hasAccess('training_group', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>View</Th>}
                ...
                {data?.map((record) => (
                  <Tr key={record.id}>
                    ...
                    {hasAccess('training_group', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link href={`/training-groups/edit/${record.id}`} passHref legacyBehavior>
                    ...
                    {hasAccess('training_group', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link href={`/training-groups/view/${record.id}`} passHref legacyBehavior>
